...
namespace BibliotekaMS.Migrations
{
    ...
    [Migration("20230609201844_rezcreate")]
    partial class rezcreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BibliotekaMS.Models.Rezervimi", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "IdentityUser")
                        .WithOne()
                        .HasForeignKey("BibliotekaMS.Models.Rezervimi", "Id");

                    b.HasOne("BibliotekaMS.Models.Libri", "Libri")
                        .WithOne()
                        .HasForeignKey("BibliotekaMS.Models.Rezervimi", "Isbn");
